...
class Game():
    def __init__(self):
        ...
        self.white = pygame.Color(102, 255, 0)
        self.brown = pygame.Color( 255,255,0)
    ...
    def set_surface_and_title(self):
        ...
        pygame.display.set_caption(' Ukrainian snake 2D ')
...
class Snake():
    ...
    def snake_body_mechanism(
        ...
        if (self.snake_head_pos[0] == food_pos[0] and
            ...
            food_pos = [random.randrange(1, screen_width/20)*20,
